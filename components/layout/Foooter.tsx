...
const NEWSLETTER_DATA = {
  title: "Newsletter",
  description:
    "Join our newsletter to receive Delicious Meals, New launches, and Discount cupon and many more",
};
...
const CONTACT_LINKS: ContactLinks = {
  contactDetails: [
    {
      icon: MapPin,
      text: "support@cuisera.com",
      link: "support@cuisera.com",
...
const Footer = ({
  ...
  return (
    <section className={cn("pt-8 pb-8 xl:pt-12", className)}>
      <div className="container space-y-10 mx-auto px-4">
        ...
        <div>
          <div className="flex items-center justify-between gap-4 md:gap-12.5">
            ...
            <div className="basis-30 md:basis-37.5">
              <p className="text-center text-6xl font-bold">Cuisera</p>
            </div>
            <Separator className="flex-1" />
          </div>
        </div>
        <div className="flex flex-wrap items-center justify-center gap-3">
          ...
          />
          <p className="max-md:text-xs">Powered by Cuisera</p>
